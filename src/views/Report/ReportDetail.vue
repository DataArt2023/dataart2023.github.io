            ...
            <div class="content">
                <div v-for="section in sections" :key="section.id" v-show="section.id === selectedSectionId">
                    ...
                    <div v-if="section.id === 'introduction'">
                        <p class="p1">We collectively retrieved 214 records from the official website of IEEE VISAP. After data cleaning (e.g., removing keynote talks & theoretical papers, and deduplicating works that were accepted by multiple venues), we ultimately obtained 178 works of artistic data visualization. These artworks were published between 2013 and 2022.</p>
                        <!-- <cricle1></cricle1> -->
